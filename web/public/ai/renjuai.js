...
export class Prediction {
    ...
    */
    constructor() {
        const ret = wasm.prediction_new();
        return Prediction.__wrap(ret);
    }
    /**
    * @param {Array<any>} probabilities
    */
    set probabilities(probabilities) {
        if (this.ptr == 0) throw new Error('Attempt to use a moved value');
        _assertNum(this.ptr);
        wasm.prediction_set_probabilities(this.ptr, addHeapObject(probabilities));
    }
    /**
    * @param {number} score
    */
    set score(score) {
        if (this.ptr == 0) throw new Error('Attempt to use a moved value');
        _assertNum(this.ptr);
        wasm.prediction_set_score(this.ptr, score);
    }
}
...
function getImports() {
    ...
    imports.wbg.__wbindgen_closure_wrapper1261 = function() { return logError(function (arg0, arg1, arg2) {
...
async function init(input) {
    if (typeof input === 'undefined') {
        input = new URL('renjuai_bg.wasm', import.meta.url);
    }
    const imports = getImports();
