...
bazel  --output_base=$(pwd)/../out build -c opt --define tflite_with_xnnpack=true --define tflite_with_xnnpack_qs8=false --define xnnpack_force_float_precision=fp16 --config=opt //tensorflow/lite/c:tensorflowlite_c
